...
- In a dataset we observe _at most_ half of the $Y^a$ (an RCT of a binary $A$)
- We write the causal effect we're interested in as $Y^{a=1}-Y^{a=0}$
...
- $Y \not\!\perp\!\!\!\perp A$ but $Y^a \!\perp\!\!\!\perp A$
...
- $Y \!\perp\!\!\!\perp A|L$ but $Y^a \!\perp\!\!\!\perp A|L$
...
- $Y \!\perp\!\!\!\perp A$ but $Y^a \!\perp\!\!\!\perp A$
...
- $Y \not\!\perp\!\!\!\perp A|S$ but $Y^a \!\perp\!\!\!\perp A|S$
